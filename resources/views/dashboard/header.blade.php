...
<head>
    ...
    <!-- Bootstrap  -->
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/stylesheets/bootstrap.css') }}">

    <!-- Theme Style -->
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/stylesheets/style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/stylesheets/responsive.css') }}">

    <!-- Colors -->
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/stylesheets/colors/color1.css') }}" id="colors">

    <!-- Animation Style -->
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/stylesheets/animate.css') }}">

    <!-- Favicon and touch icons -->
    <link rel="shortcut icon" href="{{ asset('dashboard/icon/favicon.png') }}">
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dashboard/stylesheets/responsive.css') }}">
    <link rel="stylesheet" href="{{ asset('dashboard/stylesheets/colors/color1.css') }}">
    <link rel="stylesheet" href="{{ asset('dashboard/stylesheets/animate.css') }}">
    <link rel="shortcut icon" href="{{ asset('dashboard/icon/favicon.png') }}">
</head>
                ...
                <div class="container clearfix" id="site-header-inner">
                    <div id="logo" class="logo float-left">
                        <a href="index.html" title="logo">
                            <img src="{{ asset('dashboard/images/logo.png') }}" alt="image" width="107" height="24"
                                data-retina="" data-width="107" data-height="24">
                        </a>
                    </div><!-- /.logo -->
