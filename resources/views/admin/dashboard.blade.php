    ...
    <div class="content-wrapper">
        <div class="container">
                            ...
                            <div class="widget-popular-product-container">
                                ...
                                <div class="widget-popular-product-content">
                                    ...
                                    <p class="widget-popular-product-text m-b-md">Quisque congue risus sit amet
                                        ...
                                        at
                                        tellus a nisl accumsan egestas suscipit..</p>
                                ...
                                <div class="widget-stats-large-info-container">
                                    ...
                                    <div class="card-body">
                                        <p class="card-description">Duis fringilla eget velit sit amet lobortis.
                                            Donec
                                            rutrum, arcu auctor varius cursus. mi nulla dapibus justo, at volutpat
                                            libero</p>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="card">
                        <img src="{{ asset('assets/images/widgets/blog5.jpeg') }}" alt="Blog Image">
                        <div class="card-body">
                            ...
                            <p class="card-text">Pellentesque habitant morbi tristique senectus et. Curabitur
                                molestie
                                in tellus sed porttitor. Etiam eget erat erat. Nullam auctor a justo lacinia varius.
                            </p>
                        </div>
                        <ul class="list-group list-group-flush">
                        ...
                        <div class="card-body">
                            <div class="widget-popular-blog-container">
                                <div class="widget-popular-blog-image">
                                    <img src="{{ asset('assets/images/widgets/product2.jpeg') }}" alt="Product Image">
                                ...
                                <div class="widget-popular-blog-content ps-4">
                                    ...
                                    <span class="widget-popular-blog-text">
                                        ...
                                        tristique
                                        tortor massa ut arcu. Suspendisse potenti. Suspendisse cursus aliquam
                                        dictum.
                                        Curabitur nec fringilla orci. Vivamus ut viverra elit. Pellentesque id
                                        interdum
                                        odio. Fusce finibus maximus egestas.
                                    </span>
                                </div>
                            </div>
                        </div>
